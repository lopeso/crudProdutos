...
<head>
  ...
  <title>Sistema do caralho</title>
...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="../../index2.html" class="h1">Sistema do caralho</a>
    </div>
    <div class="card-body">
      <p class="login-box-msg"><?= (isset($alert) && $alert =='error_login') ? "<span style='color: red'>usuario ou senha incorretos!</span>" : "Entre com seu usuario e senha!" ?></p>
